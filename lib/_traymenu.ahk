...
DisplayTrayMenu() {
  ...
  */
  ...
  MouseMenu.Add("Increase Mouse Cursor Size`t [⊞]+[PgUp]", IncCursorSize)
  MouseMenu.Add("Decrease Mouse Cursor Size`t [⊞]+[PgDn]", DecCursorSize)
...
IndicateToggle(AppFeatureName, AppFeature, IsEnabled := false, DisplayChange := false, PlaySound := false) {
  ...
  ; ╰──────────────────────────────────────────────────────────────────────╯
  ; IsEnabled is a boolean that indicates whether the feature is enabled or disabled
